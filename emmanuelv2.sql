...
--
-- Host: localhost
-- Generation Time: Aug 21, 2023 at 08:31 PM
...
INSERT INTO `applications` (`id`, `status`, `jobid`, `userid`) VALUES
(1, 0, 1, 2),
(2, 0, 2, 2),
(3, 0, 2, 2),
(4, 0, 1, 2),
...
INSERT INTO `jobs` (`id`, `status`, `job_title`, `company_name`, `location`, `job_description`, `job_type`, `application_deadline`) VALUES
(15, 0, 'fdfd', 'fdsf', 'fdsff', 'fdsfdsf', 'fullTime', '2023-08-11');
...
INSERT INTO `register` (`id`, `name`, `mail`, `pass`, `role`) VALUES
(1, 'nerfed', 'sarin@kerala.org.in', 'admin', 'ADMIN-JOB REGISTER'),
(2, 'Chris', 'chris@gmail.com', '1234', 'APPLICANT');
